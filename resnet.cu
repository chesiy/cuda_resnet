...
public:
    Resnet18(map<string, Dtype*> param):Parameters(param){
        ...
        neck_layer1 = new Bottleneck<Dtype>{64,128,Parameters["208"],Parameters["209"],Parameters["211"],Parameters["212"],Parameters["214"],Parameters["215"],2,2};
        ...
        layer4 = new BasicBlock<Dtype>{256,256,Parameters["232"],Parameters["233"],Parameters["235"],Parameters["236"],1};
