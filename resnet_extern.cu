...
namespace resnet{
    ...
    void resnet_init(map<string, float*> Parameters){
        conv1 = new conv_im2col{3,64,Parameters["193"],Parameters["194"], true,true, 224,224,3,1,7,1,3,2};
        maxpool = new maxpooling2d{3,1,2,112,112,64,1};
        layer1 = new BasicBlock{64,64,Parameters["196"],Parameters["197"],Parameters["199"],Parameters["200"],56,56,64,1,1};
        layer2 = new BasicBlock{64,64,Parameters["202"],Parameters["203"],Parameters["205"],Parameters["206"],56,56,64,1,1};
        neck_layer1 = new Bottleneck{64,128,Parameters["208"],Parameters["209"],Parameters["211"],Parameters["212"],
                                     Parameters["214"],Parameters["215"],2,1,56,56,64,1};
        layer3 = new BasicBlock{128,128,Parameters["217"],Parameters["218"],Parameters["220"],Parameters["221"],28,28,128,1,1};
        neck_layer2 = new Bottleneck{128,256,Parameters["223"],Parameters["224"],Parameters["226"],Parameters["227"],
                                     Parameters["229"],Parameters["230"],2,1,28,28,128,1};
        layer4 = new BasicBlock{256,256,Parameters["232"],Parameters["233"],Parameters["235"],Parameters["236"],14,14,256,1,1};
        neck_layer3 =new Bottleneck{256,512,Parameters["238"],Parameters["239"],Parameters["241"],Parameters["242"],
                                    Parameters["244"],Parameters["245"],2,1,14,14,256,1};
        layer5 = new BasicBlock{512,512,Parameters["247"],Parameters["248"],Parameters["250"],Parameters["251"],7,7,512,1,1};
        avgpool = new GlobalAvgpooling{7,7,512,1};
        gemm = new Gemm{512,1000,Parameters["fc.weight"],Parameters["fc.bias"],1,1,512,1};
    }
...
//        tensor_B = (float*)malloc( sizeof(float)*height_B*width_B*channel_B*batch );
        cudaMemcpy((void*)tensor_B, (void*)B, 1000 * sizeof(float), cudaMemcpyDeviceToHost);
